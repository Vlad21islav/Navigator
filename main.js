...
window.schedule_of_improvements = function() {
    ...
    <div class="container">
        ...
        <div class="text-container yellow-orange">
            Исправление работ проводится с 7:30 до 8:10 по понедельникам
            <br><br>
            О других днях для исправлений или оботсутствии исправлений в понедельник сообщается отдельно
        </div>
    </div>`;
    add_main_menu_button();
}
